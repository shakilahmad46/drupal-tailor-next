  ...
  const recentActivities = [
    {
      id: 1,
      type: 'measurement',
      description: 'New measurement added for Ahmed Khan - Shalwar Qameez',
      time: '2 hours ago',
      icon: (
    ...
    },
    {
      id: 2,
      type: 'order',
      description: 'Order #1234 completed for Fatima Ali',
      time: '4 hours ago',
      icon: (
    ...
    },
    {
      id: 3,
      type: 'customer',
      description: 'New customer registered: Mohammad Hassan',
      time: '1 day ago',
      icon: (
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{stats.totalMeasurements}</p>
            </div>
          </div>
        </div>
